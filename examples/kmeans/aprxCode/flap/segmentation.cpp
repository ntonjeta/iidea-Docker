...
::fap::FloatPrecTy OP_5(8,9);
::fap::FloatPrecTy OP_4(8,4);
::fap::FloatPrecTy OP_3(8,11);
::fap::FloatPrecTy OP_2(8,5);
::fap::FloatPrecTy OP_1(8,5);
::fap::FloatPrecTy OP_0(8,4);
...
extern "C"  double BELLERO_getError() {
  ...
  saveRgbImage(&srcImage,"prova.rgb",255);
...
//  fap::FloatPrecTy prec = OP_1.getPrec();  
 
//  cout << prec.mant_size; 

  return OP_1.mant_size ;
}
