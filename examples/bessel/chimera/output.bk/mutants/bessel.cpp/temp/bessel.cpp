...
double BESSJ0 ( double X )
{
    ...
    ************************************************************************/
    ...
    AX = fabs ( X );
    if ( AX < 8.0 ) {
        Y = (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) X, OP_0)), OP_0)) * (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) X, OP_0)), OP_0));
        FR = (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) R1, OP_1)), OP_1)) + (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) Y, OP_2)), OP_2)) * ( (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) R2, OP_3)), OP_3)) + (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) Y, OP_4)), OP_4)) * ( (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) R3, OP_5)), OP_5)) + (double)(double)(::fap::FloatingPointType((double) (::fap::FloatingPointType((double) Y, OP_6)), OP_6)) * ( (double)(::fap::FloatingPointType((double) R4, OP_7)) + (double)(::fap::FloatingPointType((double) Y, OP_8)) * ( (double)(::fap::FloatingPointType((double) R5, OP_9)) + (double)(::fap::FloatingPointType((double) Y, OP_10)) * (double)(::fap::FloatingPointType((double) R6, OP_10)) ) ) ) );
...
{
    // Local vars
    double e = 0, partial_e, oracle_val, b_val;
    int c = 0; // Counter

    ::std::string x, value;
    ::std::ifstream oracle ( "bessel_oracle.txt" );
    if ( !oracle.good() ) {
    ...
    oracle >> x >> value;
    do {
        ::std::cout << "X value: " << x << ". Bessel value: " << value << "\n";
        c++;
        oracle_val = ::std::atof ( value.c_str() );
        b_val = BESSJ ( 0, ::std::atof ( x.c_str() ) );
        partial_e =
            fabs ( b_val - oracle_val ) < 10e-16 ? 0 : fabs ( b_val - oracle_val );
//     ::std::cout << oracle_val << " - " << b_val << " = " << partial_e << "\n";
        if ( partial_e > e ) {
            e = partial_e;
        }
        // Next value
...
int main()
{
    ...
    ::std::ofstream oracle ( "bessel_oracle.txt", ::std::ofstream::out );
    ...
    // Get error that should be 0
    ::std::cout << "Error: " << IIDEAA_getError() << "\n";
